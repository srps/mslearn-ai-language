...
def TranscribeCommand():
    ...
    speech: speech_sdk.SpeechRecognitionResult = speech_recognizer.recognize_once_async().get()
...
def TellTime():
    ...
    speech_synthetizer = speech_sdk.SpeechSynthesizer(speech_config=speech_config)
    ...
    speak = speech_synthetizer.speak_ssml_async(response_ssml).get()
